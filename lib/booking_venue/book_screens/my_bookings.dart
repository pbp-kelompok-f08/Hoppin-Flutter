...
class _MyBookingsPageState extends State<MyBookingsPage> {
  ...
  Future<void> fetchBookings() async {
    ...
    try {
      ...
      const url = 'https://dion-wisdom-hoppin.pbp.cs.ui.ac.id/booking-venue/show-bookings-json/';
  ...
  Future<void> cancelBooking(String bookingId) async {
    ...
    try {
      final response = await request.post(
        'https://dion-wisdom-hoppin.pbp.cs.ui.ac.id/booking-venue/delete-booking/$bookingId/',
        {},
      );
